      ...
      tabItem(tabName = "input",
              ...
              sidebarLayout(
                ...
                sidebarPanel(
                  ...
                  bsTooltip(id="dataset", title="Choose a dataset.",
                                     placement = "top"),
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  selectInput("pattern_type_drop", "Pattern type",
                              ...
                              selectize = FALSE, 
                              size = 4),
                  bsTooltip(id = "pattern_type_drop",
